...
USE SCHEMA BANKING_DEMO_7RIVERS_DB.DW;
...
create or replace semantic view BANKING_DEMO_7RIVERS_DB.DW.BANKING_DEMO_7RIVERS_SV
	...
	facts (
		...
		DIM_DATE.DATE_KEY as DATE_KEY comment='Unique identifier for date dimension. Used to join date dimension to fact tables.',
